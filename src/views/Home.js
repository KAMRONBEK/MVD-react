...
function Home(props) {
			...
			<div className="ban-right-inner">
				...
				<div className="lang">
					<div className="lang-show">
						<img src={Lang}/>
						<a className="lang-link" href="#">Русский</a>
						<i className="fa fa-angle-down" aria-hidden="true"></i>
					</div>
					<ul className="lang-hide">
						<li><a className="lang-link-hide" href="#">English</a></li>
						<li><a className="lang-link-hide" href="#">O'zbek</a></li>
					</ul>
				</div>
			</div>
		</div>
             ...
             <div className="row full-row">
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="home.html">Главная</a></li>
                    </ul>
                </div>
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="#!">О министерстве</a></li>
                        <li><a href="#!">История министерства</a></li>
                        <li><a href="ruko.html">Руководство</a></li>
                        <li><a href="#!">Структура</a></li>
                        <li><a href="#!">Задачи, функции и права</a></li>
                ...
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="news.html">Пресс-центр</a></li>
                        <li><a href="news.html">Международное сотрудничество</a></li>
                        <li><a href="#!">Профилактика правонарушений</a></li>
                        <li><a href="#!">Деятельность органов внутренних дел</a></li>
                        <li><a href="#!">Работа с кадрами</a></li>
                ...
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="#!">Госуслуги</a></li>
                    </ul>
                </div>
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="#!">Обращения</a></li>
                    </ul>
                </div>
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="#!">Реестр НПА</a></li>
                    </ul>
                </div>
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="#!">Интерактивные услуги</a></li>
                    </ul>
                </div>
                <div className="col-md-3">
                    <ul className="full-menu-ul">
                        <li><a className="full-top-link" href="#!">Контакты</a></li>
                    </ul>
                </div>
             </div>
        </div>
	...
	<section className="hmobil">
		<ul>
			<li className="mob-li"><a href="home.html">Главная</a></li>
			<li className="mob-li">
				...
				<ul className="min-ul padmenu">
					<li className=""><a href="#!">История министерства</a></li>
                    <li className=""><a href="ruko.html">Руководство</a></li>
                    <li className=""><a href="#!">Структура</a></li>
                    <li className=""><a href="#!">Задачи, функции и права</a></li>
                    <li className=""><a href="#!">Подразделения министерства</a></li>
                    <li className=""><a href="#!">Подведомственные учреждение министерства</a></li>
                    <li className=""><a href="#!">Прием на службу</a></li>
                    <li className=""><a href="#!">Термины</a></li>
				</ul>
			</li>
			<li className="mob-li">
                ...
                <ul className="press-ul padmenu">
                    <li className="active"><a href="news.html">Международное сотрудничество</a></li>
                    <li className=""><a href="#!">Профилактика правонарушений</a></li>
                    <li className=""><a href="#!">Деятельность органов внутренних дел</a></li>
                    <li className=""><a href="#!">Работа с кадрами</a></li>
                    <li className=""><a href="pro.html">Без вести пропавшие</a></li>
                    <li className=""><a href="#!">Раздел «Внимание розыск!»</a></li>
                    <li className=""><a href="foto.html">Фотогалерея</a></li>
                    <li className=""><a href="video.html">Видеотека</a></li>
                </ul>
			</li>
			<li className="mob-li">
				<button className="press-btn m-all">
			...
			<li className="mob-li">
				...
				<ul className="padmenu">
					<li className=""><a href="news.html">Порядок обращений</a></li>
                    <li className=""><a href="contact.html">Контакты</a></li>
                    <li className=""><a href="#!">График обращений граждан</a></li>
                    <li className=""><a href="#!">Часто задаваемые вопросы</a></li>
                    <li className=""><a href="#!">Обращения граждан</a></li>
                    <li className=""><a href="#!">Политика защиты информации</a></li>
			...
			<li className="mob-li"><a href="#">Реестр НПА</a></li>
			<li className="mob-li"><a href="#">Интерактивные услуги</a></li>
			<li className="mob-li"><a href="#">Контакты</a></li>
		</ul>
	</section>
	<main className="menu home">
		...
		<div className="menu-ul-div">
			<ul className="menu-ul">
				<li className="m-row-li"><a href="home.html">Главная</a></li>
				<li className="m-row-li"><a href="ruko.html">О министерстве</a></li>
				<li className="m-row-li"><a href="news.html">Пресс-центр</a></li>
				<li className="m-row-li"><a href="#">Госуслуги</a></li>
				<li className="m-row-li"><a href="#">Обращения</a></li>
				<li className="m-row-li"><a href="#">Реестр НПА</a></li>
				<li className="m-row-li"><a href="#">Интерактивные услуги</a></li>
				<li className="m-row-li"><a href="#">Контакты</a></li>
			</ul>
		</div>
	</main>
				...
				<div className="col-lg-6">
					<div className="news-inner">
						...
						<div className="news-item">
							...
							<p>Состоялся визит делегации Министерства внутренних дел Республики Узбекистан в Социалистическую Республику Вьетнам</p>
							<a className="readmore" href="#">Подробнее</a>
						</div>
						<div className="news-item">
							<button className="button-yellow">6 августа 2019</button>
							<p>Состоялся визит делегации Министерства внутренних дел Республики Узбекистан в Социалистическую Республику Вьетнам</p>
					...
					<div className="reform-item">
						<div className="inner">
							...
							<div className="re-right">
								...
								<a href="#!">
									<p>Озвучен план по реформам в энергетической отрасли Узбекистана</p>
								</a>
							</div>
						</div>
					</div>
			...
			<div className="row">
				<div className="col-lg-3 col-sm-6">
					<aside className="prois-in">
						...
						<a href="#!">
							<p>Установлены и задержаны 7 лиц, скрывавшиеся от суда и следствия</p>
						</a>
					</aside>
				</div>
				<div className="col-lg-3 col-sm-6">
					<aside className="prois-in">
						...
						<button className="button-yellow">12 августа 2019</button>
						<a href="#!">
							<p>Двоих угонщиков удалось задержать в Самаркандской области</p>
						</a>
					</aside>
				</div>
				<div className="col-lg-3 col-sm-6">
			...
			<div className="row peres-row">
				<div className="col-lg-4 peres-left">
					<ul className="peres-ul">
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Город Ташкент</span>
							<span>19</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Ташкентская область</span>
							<span>8</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Самаркандская область</span>
							<span>6</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Сырдарьинская область</span>
							<span>3</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Джизакская область</span>
							<span>1</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Бухарская область</span>
							<span>4</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Навоийская область</span>
							<span>3</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Ферганская область</span>
							<span>6</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Андижанская область</span>
							<span>2</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Наманганская область</span>
							<span>1</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Сурхандарьинская область</span>
							<span>4</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Кашкадарьинская область</span>
							<span>5</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Хорезмская область</span>
							<span>2</span>
						</li>
						<li>
							<span><i className="fa fa-dot-circle-o" aria-hidden="true"></i> Республика Каракалпакстан</span>
							<span>4</span>
						</li>
				...
				<div className="col-xl-9">
					<div className="map-content uzb">
						...
						<svg
						  ...
						  <path
						     style={{fill:"#ffffff",fillOpacity:1,stroke:"#fff",strokeWidth:0.5,strokeOpacity:1}}
						...
						<div className="viloyat-div">
							<p className="viloyat-p"><i className="fa fa-dot-circle-o" aria-hidden="true"></i> <span id="title-top">Джизакская область</span></p>
						</div>
				...
				<div className="col-xl-3 col-md-6">
					<div className="xar-right">
						...
						<div className="xar-card">
							<h5>Какая категория новостей Вам интересна больше остальных?</h5>
							<div className="xar-example">
							  ...
							  <label className="radio-button">
							    ...
							    <span className="radio-button__control"></span>
							    <span className="radio-button__label">Внимание розыск!</span>
							  </label>
							  <label className="radio-button">
							    <input type="radio" className="radio-button__input" id="choice1-2" name="choice1"/>
							    <span className="radio-button__control"></span>
							...
							<div>
								...
								<button className="button-yellow xar-btn">Результаты</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div className="ctrl-enter">
			<form>
			  ...
			  <div className="form-group">
			    ...
			    <textarea id="text-area-xato" className="form-control" rows="4" cols="36"></textarea>
			  </div>
			  <div className="form-group">
			    <label for="formGroupExampleInput2">Sizning izoxingiz yoki to`g`ri versiya:</label>
			    <textarea id="text-area-right" className="form-control" rows="4" cols="36"></textarea>
			  </div>
			  <div className="ctrl-btn">
			  	<button className="btn-bekor" type="button">Bekor qilish</button>
